...
namespace QuanLySieuThi.banhang
{
    public partial class banhang : Form
    {
        ...
        {
            Dbconection.Chuoiketnoi(chuoi, db1);
        ...
        private void dta2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlDataReader rd3 = Dbconection.showtext(solg);
                while (rd3.Read())
                {
        ...
        private void btn_Add_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    double m = thanhtien + thanhtien  / 100;
        ...
        private void TongTien_Click(object sender, EventArgs e)
        {
            ...
            { 
                ...
                if(dta2.RowCount == 1)
                {
                    ...
                    //double m = thanhtien + thanhtien / 100;
                    double m = thanhtien + (thanhtien * 0.01);
                    string date = date1.Text.Trim();

                    string str1 = "Insert into chitietdonhang Values('" + s.ToString() + "','" + date + "','" + m.ToString() + "',N'" + lb_quyen.Text + "')";
                    Dbconection.them_dl1(str1);

                    string duongdan = "";
                   
                    ExportExecl.nhapnhieu(dta2, duongdan, randomNameFile,lb_tien.Text, lb_Tile.Text);
        ...
        private void thôngTinToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            tt += "Email : thanhbinh29062003@gmail.com  \n\n";
