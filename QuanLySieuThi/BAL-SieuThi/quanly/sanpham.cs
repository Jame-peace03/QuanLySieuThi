...
{ 
    public partial class sanpham : Form
    {
        ...
        private void txt_search_TextChanged(object sender, EventArgs e)
        {
            ...
            Dbconection.timkiem(load1, dta1);
            clear();
        }
        ...
        private void mancc()
        {
            ...
            Dbconection.xulycbx(load_mancc, txt_mancc);
        ...
        {
            // Tùy chỉnh định dạng ngày tháng cho DateTimePicker
            txt_hsd.Format = DateTimePickerFormat.Custom;
            txt_hsd.CustomFormat = "yyyy/MM/dd";
