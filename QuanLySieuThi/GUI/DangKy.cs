...
namespace QuanLySieuThi
{
    public partial class DangKy : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //string datecreate = spkdateTime.Text.ToString().Trim();
            ...
            else
            {
                ...
                if (password == remk)
                {
                    ...
                    {
                        MessageBox.Show("Mat khẩu bạn nhập ít nhất phải dài 4 ký tự", "Thông báo", MessageBoxButtons.OK);
                    }
                    else
                    {
                        
                        Dbconection.Themdangky(sql, username, password, sql1);
                        this.Close();
                    }
                }
                else
