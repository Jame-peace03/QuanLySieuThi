...
namespace QuanLySieuThi
{
    ...
    {
        public static string sqlcon = @"Data Source=DESKTOP-VGDP77D\SQLEXPRESS;Initial Catalog=QLST;User ID=sa;Password=123";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (a == 0)
                {
                    string t = "Tài khoản hoặc mật khẩu sai !,Bạn vui lòng kiểm tra lại ";
                    ...
                    if (getRole == 0)
                {
                    ...
                    MessageBox.Show("Đăng nhap vao tai khoan Admin thành công", "Thong bao ", MessageBoxButtons.OK);
                    main2 a1 = new main2();
                ...
                {
                    MessageBox.Show("Đăng nhap vao tai khoan Nhân Vien thành công", "Thong bao ", MessageBoxButtons.OK);
